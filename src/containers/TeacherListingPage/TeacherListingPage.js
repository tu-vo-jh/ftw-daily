...
import { LISTING_STATE_PENDING_APPROVAL, LISTING_STATE_CLOSED, propTypes, LINE_ITEM_HOUR } from '../../util/types';
...
export class TeacherListingPageComponent extends Component {
    ...
    render() {
        ...
        const teachingTypeOptions = findOptionsForSelectFilter('teachType', filterConfig);
        return (
            <Page
                title={schemaTitle}
                        ...
                        <div>
                            ...
                            <div className={css.contentContainer}>
                                ...
                                <div className={css.mainContent}>
                                    ...
                                    />
                                    <SectionDescriptionMaybe description={description} isTeacher={!!publicData.subjects} />
                                    <SectionSubjects options={subjectOptions} publicData={publicData} />
                                    <SectionLevels options={levelOptions} publicData={publicData} />
                                    <SectionTeachingType options={teachingTypeOptions} publicData={publicData} />
                                    <SectionMapMaybe
