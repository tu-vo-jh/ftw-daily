...
const TeacherBookingTimeInfoComponent = props => {
...
TeacherBookingTimeInfoComponent.defaultProps = { dateType: null };

TeacherBookingTimeInfoComponent.propTypes = {
...
const TeacherBookingTimeInfo = injectIntl(TeacherBookingTimeInfoComponent);

export default TeacherBookingTimeInfo;
