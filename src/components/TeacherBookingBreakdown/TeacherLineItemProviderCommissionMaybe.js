...
const TeacherLineItemProviderCommissionMaybe = props => {
        ...
        commissionItem = (
            <div className={css.lineItem}>
                <span className={css.itemLabel}>
                    <FormattedMessage id="TeacherBookingBreakdown.commission" />
                </span>
...
TeacherLineItemProviderCommissionMaybe.propTypes = {
    transaction: propTypes.transaction.isRequired,
    isProvider: bool.isRequired,
    intl: intlShape.isRequired,
};

export default TeacherLineItemProviderCommissionMaybe;
