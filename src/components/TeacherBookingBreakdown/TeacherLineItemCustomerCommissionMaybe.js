...
const TeacherLineItemCustomerCommissionMaybe = props => {
        ...
        commissionItem = (
            <div className={css.lineItem}>
                <span className={css.itemLabel}>
                    <FormattedMessage id="TeacherBookingBreakdown.customerCommission" />
                </span>
...
TeacherLineItemCustomerCommissionMaybe.propTypes = {
    transaction: propTypes.transaction.isRequired,
    isCustomer: bool.isRequired,
    intl: intlShape.isRequired,
};

export default TeacherLineItemCustomerCommissionMaybe;
